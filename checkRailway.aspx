<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="checkRailway.aspx.cs" Inherits="online_Book_System.checkRailway" %>
        ...
        <form id="form1">
            <div align="center" style="height: 469px">
             ...
             <div style="width: 353px; font-size: large; font-weight: bold; color: #FFFFCC; float: left;" align="right">Aadhaar No:-</div>
                ...
                <div style="width: 283px; font-size: large; font-weight: bold; color: #003366;">
                    &nbsp;
                  <asp:TextBox ID="TextBox1" onkeypress="return isNumberKey(event)" runat="server" Width="114px" Font-Bold="True" Height="20px"></asp:TextBox>
                </div>
                <br />
                ...
                <br />
                     <div style="width: 353px; font-size: large; font-weight: bold; color: #FFFFCC; float: left;" align="right"> Journey Quota:-</div>
                <div style="width: 283px; font-size: large; font-weight: bold; color: #003366;">
                    &nbsp;
                  <asp:TextBox ID="TextBox2" onkeypress="return isNumberKey(event)" runat="server" Width="211px" Font-Bold="True" Height="20px"></asp:TextBox>
